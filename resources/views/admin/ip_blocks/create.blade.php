...
@section('title', __('global.create_ip_block'))

@section('content_header')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1>{{ __('global.create_ip_block')}}</h1>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">{{ __('global.home')}}</a></li>
                <li class="breadcrumb-item"><a href="{{route('admin.ip-blocks.index')}}">{{ __('global.ip_blocks')}}</a></li>
                <li class="breadcrumb-item active">{{ __('global.create_ip_block')}}</li>
            </ol>
...
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{route('admin.ip-blocks.store')}}" method="POST" enctype="multipart/form-data" id="admin-form">
                        @csrf
                        @if (count($errors) > 0)
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input id="ip_address" name="ip_address" class="form-control" placeholder="{{ __('global.enter_ip_address')}}">
                                </div>
                            </div>
