...
@section('title', __('global.create_payment_method'))

@section('content_header')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1>{{ __('global.create_payment_method')}}</h1>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">{{ __('global.home')}}</a></li>
                <li class="breadcrumb-item"><a href="{{route('admin.payment-methods.index')}}">{{ __('global.ayment_methods')}}</a></li>
                <li class="breadcrumb-item active">{{ __('global.create_payment_method')}}</li>
            </ol>
...
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{route('admin.payment-methods.store')}}" method="POST" enctype="multipart/form-data" id="admin-form">
                        @csrf
                        @if (count($errors) > 0)
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input id="name" name="name" class="form-control" placeholder="{{ __('global.enter_payment_method')}}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
