...
@section('content_header')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1>{{__('global.categories')}} {{__('global.deleted')}}</h1>
            @can('category_list')
                <a href="{{route('admin.categories.index')}}" class="btn btn-primary mt-2">{{__('global.go_back')}}</a>
            @endcan
                            ...
                            @foreach($categories as $category)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        @can('category_delete')
                                        <a href="{{route('admin.categories.restore',['category'=>$category->id])}}"  class="btn btn-success btn-sm px-1 py-0"><i class="fa fa-arrow-left"></i></a>
                                        <a href="{{route('admin.categories.force_delete',['category'=>$category->id])}}"  class="btn btn-danger btn-sm px-1 py-0"><i class="fa fa-trash"></i></a>
                                        @endcan
                                    </td>
                                </tr>
                            @endforeach
