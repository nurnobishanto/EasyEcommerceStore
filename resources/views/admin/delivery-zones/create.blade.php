...
@section('title', __('global.create_delivery_zone'))

@section('content_header')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1>{{ __('global.create_delivery_zone')}}</h1>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">{{ __('global.home')}}</a></li>
                <li class="breadcrumb-item"><a href="{{route('admin.delivery-zones.index')}}">{{ __('global.delivery_zones')}}</a></li>
                <li class="breadcrumb-item active">{{ __('global.create_delivery_zone')}}</li>
            </ol>
...
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{route('admin.delivery-zones.store')}}" method="POST" enctype="multipart/form-data" id="admin-form">
                        @csrf
                        @if (count($errors) > 0)
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input id="name" name="name" class="form-control" placeholder="{{ __('global.enter_delivery_zone')}}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
